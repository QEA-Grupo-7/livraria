...
public class Main {
    ...
    private static void menu(Scanner scanner) throws IOException {
        ...
        System.out.println("2 - Buscar autor pelo nome");
        ...
        switch (opcao) {
            ...
            case "1": {
                buscarObraNoAcervo(scanner);
                break;
            }
            case "2": {
                buscarAutorPeloNome(scanner);
                break;
            }
        }
    }

    private static void buscarObraNoAcervo(Scanner scanner) throws IOException {
    ...
    private static void buscarAutorPeloNome(Scanner scanner) throws IOException {
        System.out.println("Digite o nome do autor: ");
        String busca = scanner.nextLine();

        System.out.println("Buscando autor com nome '" + busca + "'...");
        ...
        if (autorEncontrado != null) {
            ...
            System.out.println("Nome: " + autorEncontrado.getNome());
            System.out.println("");
        } else {
    ...
    private static List<Autor> getAutores() throws IOException {
        ...
        Reader reader = Files.newBufferedReader(Paths.get(PATH + "authors.json"), StandardCharsets.UTF_8);
